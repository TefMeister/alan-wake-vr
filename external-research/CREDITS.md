...
| Alan Wake PC Update #2 coverage (pinned `-rigidcamera` to v1.02 and `-directaiming` to v1.03, and recorded that v1.03 reworked the low-level mouse reading for low/variable frame rates) | DSOGaming | https://www.dsogaming.com/news/alan-wake-pc-update-2-released-reduced-cpu-usage-improved-mouse-responsiveness-removed-auto-aim/ |
