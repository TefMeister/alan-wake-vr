...
| --- | --- | --- | --- |
| 2026-08-25 | [Native -freecamera + -developermenu launch flags](topics/2026-08-25-native-freecamera-developermenu-launch-flags.md) | 🆕 new | The retail game ships two real Remedy-added dev tools reachable via launch options — a free camera (controller-driven) and a Developer Menu — plus a well-documented full command-line flag set. Same category as the Psychonauts precedent: a dormant official tool, not something to reverse-engineer. |
| 2026-08-25 | [Native 3D Vision support + HelixMod](topics/2026-08-25-native-3d-vision-support-and-helixmod.md) | 🆕 new | The game shipped with real NVIDIA 3D Vision support, with later patches reportedly needing little to no third-party fixing; live Ctrl+F3/Ctrl+F4 separation hotkeys are a strong hint the per-eye offset mechanism is already reachable. |
| 2026-08-25 | [DRM history + vorpX status](topics/2026-08-25-drm-history-and-vorpx-status.md) | 🆕 new | Originally shipped on Games for Windows Live (undated removal, unlike Alice/PoP2008's clean dated patches); vorpX works but only confirmed in the weaker Cinema mode for the original game — a real gap vs. this portfolio's stronger fronts, recorded honestly. |
